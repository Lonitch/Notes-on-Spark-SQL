...
-- MAGIC 
-- MAGIC ## ![Spark Logo Tiny](https://files.training.databricks.com/images/105/logo_spark_tiny.png) Here we:
...
-- MAGIC ### Question 8
-- MAGIC 
-- MAGIC Count the total incidents from the two joined tables.
-- MAGIC 

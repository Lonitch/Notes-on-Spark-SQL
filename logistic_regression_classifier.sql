...
-- MAGIC y_pred = pipeline.predict(X_train)
...
-- MAGIC print(f"Accuracy of model: {accuracy_score(y_pred, y_train)}")
...
-- MAGIC %python
-- MAGIC X_test.to_csv("/dbfs/" + username + "/Call_Type_Group_lr"+ "/modeltest.csv")
-- MAGIC dbutils.fs.ls("/liu_si_zhe@outlook.com/Call_Type_Group_lr/")
